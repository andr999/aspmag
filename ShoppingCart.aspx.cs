...
public partial class ShoppingCart : System.Web.UI.Page
{
    ...
    {
        //poulate the control only on the initial page load
        if (!IsPostBack)
            PopulateControls();
    }
    ...
    protected void grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        // Display status
        statusLabel.Text = success ? "Product successfully deleted!" :
                                      "There was en error removing the product!";
        //Repoulate the control
        PopulateControls();
    }
     ...
     protected void updateButton_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < rowsCount; i++)
        {
            //Get a row
            gridRow = grid.Rows[i];
            //TheID of the product being deleted
            ...
            statusLabel.Text = success ? "Your shopping cart was successfully updated!" :
