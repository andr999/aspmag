...
public static class BalloonShopConfiguration
{
    ...
    //Return URL after a successful translation
    ...
    //Return URL after a cancelled translation
    ...
    //Return the number of days for shoping cart expiration
    public static int CartPersistDays
    {
        get
        {
            return int.Parse(ConfigurationManager.AppSettings["CartPersistDay"]);
        }
    }
