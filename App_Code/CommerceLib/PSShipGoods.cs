                     ...
                     try
                         {
                          ...
                          orderProcessor.MailSupplier("BalloonShop ship goods.",GetMailBody());
                         // audit
                         orderProcessor.CreateAudit("Ship goods e-mail sent to supplier.", 20502);
                        // update order status
      ...
      private string GetMailBody()
           {
                ...
                string mail ="Payment has been received for the following goods:\n\n"
                ...
                + "http://localhost/AdminOrders.aspx"
