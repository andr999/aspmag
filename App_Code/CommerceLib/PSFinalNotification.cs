          ...
          public void Process(OrderProcessor processor)
             {
               ...
               // audit
               orderProcessor.CreateAudit("PSFinalNotification started.",20700);
            try
                {
                    // send mail to customer
                    orderProcessor.MailCustomer("BalloonShop order dispatched.",GetMailBody());
                    // audit
                    orderProcessor.CreateAudit("Dispatch e-mail sent to customer.", 20702);
                    // update order status
            ...
            catch
                {
                    ...
                    throw new OrderProcessorException("Unable to send e-mail to customer.", 7);
                }
                    // audit
