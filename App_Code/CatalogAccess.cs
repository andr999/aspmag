...
public static class CatalogAccess
{
    ...
    public static bool UpdateDepartment(string id, string name, string description)
    {
        ...
        {
            //any errors are loggedin GenericDataAccess we ignore them here
        }
        //result will be 1 in caase of success
        return (result != -1);
    }
    //Delete department
    public static bool DeleteDepartment(string id)
    {
        ...
        param.DbType = DbType.Int32;
        comm.Parameters.Add(param);
        //execute the sorted procedure; an error will be thrown by the
    ...
    public static bool DeleteCategory(string id)
    {
        ...
        param.DbType = DbType.Int32;
        comm.Parameters.Add(param);
        //execute the stored procedure; an error be thrown by the
    ...
    public static DataTable GetAllProductsInCategory(string CategoryId)
    {
       //get a configured DbCommand object
        ...
        param.DbType = DbType.Int32;
        comm.Parameters.Add(param);
        //execute the stored procedure and save results in a DataTable
        DataTable table = GenericDataAccess.ExecuteSelectCommand(comm);
        return table;
    }
    ...
    //get categories that contains a specified products
