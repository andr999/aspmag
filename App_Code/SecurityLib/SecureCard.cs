    ...
    public class SecureCard
    {
        ...
        private void ExtractXml()
        {
          //get card details out of XML document
            ...
            expiryDate = xmlCardData.GetElementsByTagName("ExpiryDate").Item(0).InnerXml;
        ...
        private void EncryptData()
        {
            try
            {
                ...
                CreateXml();
                //encrypt data
                encryptedData = StringEncryptor.Encrypt(xmlCardData.OuterXml);
                //set encrypted flag
                isEncrypted = true;
            }
            catch
        ...
        private void DecryptData()
        {
            try
            {
                //decrypt data 
                xmlCardData = new XmlDocument();
                xmlCardData.InnerXml = StringEncryptor.Decrypt(encryptedData);
